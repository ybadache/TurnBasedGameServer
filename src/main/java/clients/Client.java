...
public interface Client {
	 ...
	 */
	public String sendMessageWithAnswer(String receivedMessage, RequestHandler servRequest);
	
	/**
	 * Tranfers a message from the game to the client.
	 * @param message message received from the game
	 */
	public void sendMessage(String message, RequestHandler servRequest);
	
	/**
	 * Closes the connection of the client.
	 */
	public void closeConnection(RequestHandler servRequest);
