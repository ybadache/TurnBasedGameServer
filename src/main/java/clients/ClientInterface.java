...
public class ClientInterface {
	 ...
	 */
	public String receiveMessage(Player player, RequestHandler servRequest) {
	 ...
	 */
	public void sendPlayedMove(String moveDescription, Player player, RequestHandler servRequest) {
	 ...
	 */
	public void sendError(int i, Player player, RequestHandler servRequest) {
		Client client = this.playersToClients.get(player);
	 ...
	 */
	public void sendEnd(Set<Player> winners, RequestHandler servRequest) {
	 ...
	 */
	public void closeConnections(RequestHandler servRequest){
